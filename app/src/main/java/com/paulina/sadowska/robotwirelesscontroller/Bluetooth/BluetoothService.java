...
public class BluetoothService {
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                if (secure) {
                    //na windows phone: OBEXObjectPushServiceClass UUID= '{00001105-0000-1000-8000-00805F9B34FB}';
                    //na module bluetooth tylko jeden numer uuid dostepny
                    ParcelUuid[] list = mmDevice.getUuids();
                    UUID uuid = mmDevice.getUuids()[0].getUuid();
                    tmp = mmDevice.createRfcommSocketToServiceRecord(uuid);
                } else {
                    UUID uuid = mmDevice.getUuids()[1].getUuid();
