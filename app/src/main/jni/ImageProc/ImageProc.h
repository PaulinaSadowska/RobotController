...
int Java_com_paulina_sadowska_robotwirelesscontroller_Wifi_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_com_paulina_sadowska_robotwirelesscontroller_Wifi_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
